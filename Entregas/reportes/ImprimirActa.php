...
$html.='
	...
	<div class="col-xs-5">
		<div class="" >
			...
			<div >
				<div class="col-md-6">
				<h5><small>	</small></h5>
				<h5><small>	Entrega:  __________________________________</small></h5>
				</div>
			</div>		
			...
			<div >
				<div class="col-md-6">
				<h5><small>	</small></h5>
				<h5><small>	Aprueba: 	__________________________________</small></h5>
				</div>
			</div>			
		</div>
</div>
	...
	<div class="col-xs-5 text-Left">
			...
			<div >
				<div class="col-md-6">
				<h5><small>	</small></h5>
				<h5><small>	Recibe Almacen: __________________________________</small></h5>
				</div>
			</div>
			...
			<div >
				<div class="col-md-6">
				<h5><small>	</small></h5>
				<h5><small>	Firma Seguridad: __________________________________</small></h5>
				</div>
			</div>	
